...
local spinner = require("neorg.modules.external.execute.spinner")

local module = neorg.modules.create("external.execute")
...
module.config.public = require("neorg.modules.external.execute.config")
